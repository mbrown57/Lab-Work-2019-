...
```{r}
#So I would use the case_when() function but first mutate a new column named Cardinal health facilities with the same name. In the case when function I would specify thta anything with the word Cardinal health facilities would be in my new column and create a second command saying that all other reporters would be labeled as other reporters. 
```
