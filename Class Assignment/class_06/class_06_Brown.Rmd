...
```{r}
#These were the three functions I used to find some of the supplementary data 
combined_buyer_monthly('arcos')

summarized_county_annual('arcos')

total_manufacturers_county('arcos')
```
